...
class OSINTScanner:
    def __init__(self):
        ...
        if not self.shodan_api_key:
            self.console.print("[yellow]Warning: Shodan API key not found in .env — module Shodan désactivé[/yellow]")
    ...
    def search_shodan(self, query):
        ...
        if not self.shodan_api:
            self.console.print("[yellow]Shodan indisponible (clé API manquante)[/yellow]")
            return None
        try:
